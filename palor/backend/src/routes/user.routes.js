...
import { changePassword, login, logout, signup, updateAccountDetails, addExperience, updateExperience, removeExperience, createWalkInUser } from "../controller/user.controllers.js";
...
userRouter.route('/walkin').post(verifyJWT,verifyAdmin,createWalkInUser);
